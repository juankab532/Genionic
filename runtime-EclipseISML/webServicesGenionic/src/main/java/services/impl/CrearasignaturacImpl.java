...
import services.interfaces.Crearasignaturac;


/**
 * This class represents an EJB named CrearasignaturacImpl
 */
@Stateless
public class CrearasignaturacImpl extends Persistence<AsignaturaE> implements Crearasignaturac,Serializable{
