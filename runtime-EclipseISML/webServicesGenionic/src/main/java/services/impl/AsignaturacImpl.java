...
import services.interfaces.Asignaturac;


/**
 * This class represents an EJB named AsignaturacImpl
 */
@Stateless
public class AsignaturacImpl extends Persistence<AsignaturaE> implements Asignaturac,Serializable{
