...
import services.interfaces.Facultadc;


/**
 * This class represents an EJB named FacultadcImpl
 */
@Stateless
public class FacultadcImpl extends Persistence<FacultadE> implements Facultadc,Serializable{
   ...
   @PersistenceContext
	 ...
	 */
	public FacultadcImpl(){
		super(FacultadE.class);
	}
	 ...
	 */
	@Override
	public void remove(FacultadE obj){
		super.remove(obj);	
	}
	/**
	 * This method executes the proper actions for remove
	 ...
	 */
	@Override
	public void create(FacultadE obj){
		super.create(obj);	
	}
	/**
	 ...
	 * @param id Parameter from type Integer
	 * @return Some FacultadE object
	 */
	@Override
	public FacultadE find(Long id){
	 ...
	 */
	@Override
	public void save(FacultadE obj){
		super.save(obj);	
	}
	/**
	 ...
	 */
	@Override
	public void addToCollection(Object container,Collection collection,FacultadE obj){
