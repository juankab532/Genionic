 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.javeriana.isml.isml.impl.CallerImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CallerImpl extends MinimalEObjectImpl.Container implements Caller
{
	...
	{
		return IsmlPackage.Literals.CALLER;
	}
	...
	public EList<Expression> getParameters()
	{
		if (parameters == null)
		{
			parameters = new EObjectContainmentEList<Expression>(Expression.class, this, IsmlPackage.CALLER__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case IsmlPackage.CALLER__PARAMETERS:
