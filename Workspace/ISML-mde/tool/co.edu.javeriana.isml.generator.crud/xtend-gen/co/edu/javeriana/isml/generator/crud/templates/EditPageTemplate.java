...
public class EditPageTemplate extends SimpleTemplate<Entity> {
  @Inject
  @Extension
  ...
  protected CharSequence template(final Entity e) {
    ...
    _builder.newLine();
    {
      ...
      for(final Attribute a : _allAttributes) {
        _builder.append("\t\t");
        CharSequence _templateEdit = this._commonTemplates.templateEdit(e, a, true);
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("Button(\"Cancel\", false) -> listAll();");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
