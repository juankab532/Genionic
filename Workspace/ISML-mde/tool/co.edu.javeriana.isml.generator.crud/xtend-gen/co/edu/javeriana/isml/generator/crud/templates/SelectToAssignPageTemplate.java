...
public class SelectToAssignPageTemplate extends SimpleTemplate<Entity> {
  @Inject
  @Extension
  ...
  protected CharSequence template(final Entity e) {
    ...
    _builder.append(", Any container, String attribute) controlledBy ");
    ...
    _builder.append("(container, attribute, ");
