...
import co.edu.javeriana.isml.generator.crud.templates.ControllerTemplate;
...
public class ControllerGenerator extends SimpleGenerator<Entity> {
  @Inject
  @Extension
  ...
  protected String getOutputConfigurationName() {
    return CRUDGenerator.CONTROLLERS;
  }
