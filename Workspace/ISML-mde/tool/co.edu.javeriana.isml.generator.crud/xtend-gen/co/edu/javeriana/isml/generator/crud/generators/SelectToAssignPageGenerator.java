...
import co.edu.javeriana.isml.generator.crud.templates.SelectToAssignPageTemplate;
...
public class SelectToAssignPageGenerator extends SimpleGenerator<Entity> {
  @Inject
  @Extension
  ...
  protected String getFileName(final Entity e) {
    ...
    String _plus_1 = (_plus + _selectToAssignPage);
    return (_plus_1 + ".isml");
  }
  ...
  public SimpleTemplate<Entity> getTemplate() {
    return new SelectToAssignPageTemplate();
  }
}
