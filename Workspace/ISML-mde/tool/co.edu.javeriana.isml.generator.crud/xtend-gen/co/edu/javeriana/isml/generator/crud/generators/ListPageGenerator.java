...
import co.edu.javeriana.isml.generator.crud.templates.ListPageTemplate;
...
public class ListPageGenerator extends SimpleGenerator<Entity> {
  @Inject
  @Extension
  ...
  protected String getFileName(final Entity e) {
    ...
    String _plus_1 = (_plus + _listPage);
    return (_plus_1 + ".isml");
  }
